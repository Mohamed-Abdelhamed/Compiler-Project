...
class Lexer():
    ...
    def _add_tokens(self):
        ...
        self.lexer.add('Whether_Do', r'WhetherDo')
        ...
        self.lexer.add('Case_Of', r'CaseOf')
        self.lexer.add('Start_Statement', r'Beginning')
        self.lexer.add('End_Statement', r'End')
        self.lexer.add('Comment_Line', r'\/\-')
        self.lexer.add('Comment_Block_Start', r'\/\#')
        self.lexer.add('Comment_Block_End', r'\#\/')
        ...
        self.lexer.add('Less-thanOrEqual', r'\<\=')
        self.lexer.add('Greater-thanOrEqual', r'\>\=')
        self.lexer.add('Equal', r'\=')
        self.lexer.add('Dot', r'\.')
        self.lexer.add('Opened_Parenthesis', r'\{')
        self.lexer.add('Closed_Parenthesis', r'\}')
        self.lexer.add('Opened_Bracket', r'\(')
